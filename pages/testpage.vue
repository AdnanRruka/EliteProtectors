...
<template>
  <div>
    ...
    <ULandingSection id="about" :title="t('AboutUs')">
      <ULandingCard
        color="sky"
        :title="t('AboutUs')"
    ...
    <ULandingSection>
      <ULandingCard color="rose">
        <ULandingSection
          ...
          :features="ePGoalList"
        >
          <img :src="epGoals" class="w-auto rounded-md" />
        </ULandingSection>
      </ULandingCard>
    </ULandingSection>
    <ULandingHero
    ...
    <ULandingSection
      :title="t('WhyYouShouldChooseUs')"
      :description="t('WhyYouShouldChooseUsText')"
    >
      <UPageGrid
        id="features"
